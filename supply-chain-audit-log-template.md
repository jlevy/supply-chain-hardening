...
[hardening-npm.md → “Keeping A Supply Chain Audit Log”](https://github.com/jlevy/supply-chain-hardening/blob/main/hardening-npm.md#keeping-a-supply-chain-audit-log).
